...
int main() {
    ...
    while (1) {
        ...
        precisionCount = kernels[KERNEL](array, integerDimension, precision, 0);
        ...
        printf("(%d) Precision count: %d/%d \r", iteration, precisionCount, (integerDimension - 2) * (integerDimension - 2));
